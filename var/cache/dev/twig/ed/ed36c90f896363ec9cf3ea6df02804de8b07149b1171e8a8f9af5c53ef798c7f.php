...
/* base.html.twig */
class __TwigTemplate_f942b1941544711ea250b505262927f4edcbb25c41849a00f15dce32d0fdf678 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_header($context, array $blocks = [])
    {
        ...
        if ((null === twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 22, $this->source); })()), "user", [], "any", false, false, false, 22))) {
            ...
            echo "\">S'identifier</a>
                            ...
                            <li class=\"nav-item\">
                                <a class=\"nav-link\" href=\"";
            // line 28
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("register_as_member");
        ...
        if ( !(null === twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 47, $this->source); })()), "user", [], "any", false, false, false, 47))) {
            ...
            echo "\" class=\"coconuts-navbar-user-thumbnail\"/>
                    ";
        }
        // line 51
    ...
    public function block_javascripts($context, array $blocks = [])
    {
        ...
        // line 69
        echo "        <script src=\"https://kit.fontawesome.com/ef10a582ff.js\" crossorigin=\"anonymous\"></script>
        ";
        // line 70
    ...
    {
        return array (  280 => 70,  277 => 69,  267 => 68,  249 => 61,  231 => 51,  224 => 49,  219 => 48,  217 => 47,  214 => 46,  208 => 43,  205 => 42,  199 => 39,  196 => 38,  194 => 37,  189 => 35,  185 => 33,  179 => 31,  173 => 28,  166 => 24,  163 => 23,  161 => 22,  151 => 15,  138 => 13,  124 => 7,  114 => 6,  95 => 5,  82 => 72,  80 => 68,  72 => 62,  70 => 61,  67 => 60,  65 => 13,  60 => 10,  58 => 6,  54 => 5,  48 => 1,);
    }
                ...
                <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
                    <ul class=\"navbar-nav mr-auto\">
                        {% if app.user is null %}
                            ...
                            <li class=\"nav-item\">
                                <a class=\"nav-link\" href=\"{{ path('register_as_member') }}\">Devenir Membre</a>
                            </li>
                             <li class=\"nav-item\">
                    ...
                    {% if app.user is not null %}
                        ...
                        <img src=\"{{ vich_uploader_asset(app.user) }}\" alt=\"{{ app.user.username }}\" class=\"coconuts-navbar-user-thumbnail\"/>
                    {% endif %}
